...
export default function Transfer() {
  ...
  const [form, setForm] = useState({
    accountNumber: '', targetAccountNumber: '', amount: '', description: ''
  })
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <p style={styles.successSub}>Sent to: {form.targetAccountNumber}</p>
        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.field}>
              ...
              <input
                type="text" placeholder="Enter target account number"
            ...
            <div style={styles.field}>
              ...
              <input
                type="text" placeholder="e.g. Rent payment"
...
const styles = {
  ...
  successAmt: { fontSize: '36px', fontWeight: '700', color: '#2E86C1', marginBottom: '8px' },
