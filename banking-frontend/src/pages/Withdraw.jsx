        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.field}>
              ...
              <input
                type="text" placeholder="e.g. ATM withdrawal"
                value={form.description}
                onChange={e => setForm({ ...form, description: e.target.value })}
                style={styles.input}
              />
            </div>
            <button type="submit" style={{ ...styles.btn, background: '#922B21', opacity: loading ? 0.7 : 1 }} disabled={loading}>
...
const styles = {
  ...
  title: { fontSize: '22px', fontWeight: '700', color: '#922B21', marginBottom: '24px' },
  ...
  btn: { padding: '13px', background: '#922B21', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '15px', fontWeight: '600', cursor: 'pointer' },
  ...
  successAmt: { fontSize: '36px', fontWeight: '700', color: '#922B21', marginBottom: '8px' },
